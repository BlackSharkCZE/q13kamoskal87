...
/**
 * <p>Java class for odpoved_poz complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="odpoved_poz">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Vypis_poz" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}subjekt_ISPOZ" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "odpoved_poz", propOrder = {
    "pid",
    "e",
    "vh",
    "pza",
...
public class OdpovedPoz {
    ...
    @XmlElement(name = "PZA")
    protected int pza;
    @XmlElement(name = "Vypis_poz")
    protected List<SubjektISPOZ> vypisPoz;
    ...
    /**
     * Gets the value of the vypisPoz property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vypisPoz property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVypisPoz().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SubjektISPOZ> getVypisPoz() {
        if (vypisPoz == null) {
            vypisPoz = new ArrayList<SubjektISPOZ>();
        }
        return this.vypisPoz;
    }
