 ...
 *         &lt;element name="Rvp" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}registr_rvp" maxOccurs="unbounded" minOccurs="0"/>
...
public class RegistrySzr {
    ...
    /**
     * Gets the value of the rvp property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rvp property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<RegistrRvp> getRvp() {
        if (rvp == null) {
            rvp = new ArrayList<RegistrRvp>();
        }
        return this.rvp;
    }
